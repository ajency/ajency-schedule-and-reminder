...
/**
 * Ajency Schedule and Reminder class.
 *
 * @package AjencyScheduleAndReminder
 * @author  Team Ajency <team@ajency.in>
 */
class AjencyScheduleAndReminder{
	/**
	 ...
	 * @var      string
	 */
	protected $plugin_slug = "ajency-schedule-and-reminder";
	 ...
	 * @var      string
	 */
	protected $plugin_screen_hook_suffix = 'ajency-schedule-and-reminder';
	 ...
	 * action, false if WPMU is disabled or plugin is activated on an individual blog.
	 */
	 ...
	 * "Network Deactivate" action, false if WPMU is disabled or plugin
	 * is deactivated on an individual blog.
	 */
	...
	public function enqueue_styles() {
		wp_enqueue_style($this->plugin_slug . "-plugin-styles",
						plugins_url("css/public.css", __FILE__), array(),
						$this->version);
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script($this->plugin_slug . "-plugin-script",
						plugins_url("js/public.js", __FILE__), array("jquery"),
						$this->version);
	}
